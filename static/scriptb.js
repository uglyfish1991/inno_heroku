window.onload = function(){
    ...
    var canvas_width = document.getElementById('particle-frame').clientWidth;
    var canvas_height = document.getElementById('particle-frame').clientHeight;

    // settings
    var frame_rate = 31; // per second
    var max_particle_size = 5; // pixels
